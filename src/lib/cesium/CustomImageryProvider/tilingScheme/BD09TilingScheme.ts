...
class BD09TilingScheme extends WebMercatorTilingScheme {
    ...
    constructor(options?: any) {
        ...
        this.projection.project = function (cartographic, result: any): any {
            result = result || {}
     ...
     * @returns {Rectangle|*}
     */
    tileXYToNativeRectangle(x: number, y: number, level: number, result: Rectangle) {
     ...
     * @returns {undefined|*}
     */
    positionToTileXY(position: Cartographic, level: number, result: any) {
