...
export default class viewshed extends analyser {
    ...
    set horizontalViewAngle(value: number) {
    ...
    set verticalViewAngle(value: number) {
...
//获取偏航角
function getHeading(fromPosition: Cesium.Cartesian3, toPosition: Cesium.Cartesian3) {
...
//获取俯仰角
function getPitch(fromPosition: Cesium.Cartesian3, toPosition: Cesium.Cartesian3) {
    let finalPosition = new Cesium.Cartesian3();
    let matrix4 = Cesium.Transforms.eastNorthUpToFixedFrame(fromPosition);
    Cesium.Matrix4.inverse(matrix4, matrix4);
    Cesium.Matrix4.multiplyByPoint(matrix4, toPosition, finalPosition);
